...
public class Ejercicio5 {
    ...
    public static void main(String[] args) {
        ...
        double media = 0;           //Variable donde vamos a guardar el resultado de la media de los numeros negativos introducidos

        //Declaramos el scanner para poder leer por consola
        Scanner sc = new Scanner(System.in);

        //Le pedimos al usuario que introduzca un número entero cualquiera y lo guardamos en la variable num
        ...
        while (contador < 10) {                                     //Mientras que el contador de numeros sea menor que 10
            ...
            //Le pedimos al usuario que introduzca otro número y lo volvemos a guardar en la variable num
            System.out.println("Introduzca otro numero");
            num = sc.nextInt();
            contador++;                                             //Incrementamos el contador de numeros introducidos en 1
        }

        //Una vez que salgamos del bucle imprimimos por pantalla la suma de los numeros positivos, la media de los negtivos y la cantidad de 0
